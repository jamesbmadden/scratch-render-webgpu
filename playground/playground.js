...
const fudgeInput = document.querySelector('input#fudge') || document.createElement('input');
const fudgePropertyInput = document.querySelector('select#fudgeproperty') || document.createElement('select');
const fudgeMinInput = document.querySelector('input#fudgeMin') || document.createElement('input');
const fudgeMaxInput = document.querySelector('input#fudgeMax') || document.createElement('input');
...
const stageScaleInput = document.querySelector('input#stage-scale') || document.createElement('input');
